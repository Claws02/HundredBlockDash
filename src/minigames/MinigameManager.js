...
const MG_MODULES = {
    math:        () => import('./MathBlitz.js'),
    trivia:      () => import('./TriviaShootout.js'),
    trace:       () => import('./Constellation.js'),
    reaction:    () => import('./ReactionTap.js'),
    colormatch:  () => import('./ColorMatch.js'),
    memory:      () => import('./MemoryFlip.js'),
    sequence:    () => import('./SequenceRepeat.js'),
    countdown:   () => import('./CountdownStop.js'),
    shapetap:    () => import('./ShapeTap.js'),
    oddoneout:   () => import('./OddOneOut.js'),
    highlow:     () => import('./HigherLower.js'),
    pulsehold:   () => import('./PulseHold.js'),
    gridrecall:  () => import('./GridRecall.js'),
    wordscramble:() => import('./WordScramble.js'),
    colorrush:   () => import('./ColorRush.js'),
    rhythmtap:   () => import('./RhythmTap.js'),
    speedsort:   () => import('./SpeedSort.js'),
    ...
    laserduel:    () => import('./LaserDuel.js'),
    orbitorbs:    () => import('./OrbitOrbs.js'),
    bombtap:      () => import('./BombTap.js'),
    meteorshield: () => import('./MeteorShield.js'),
    dashdots:     () => import('./DashDots.js'),
    splithockey:  () => import('./SplitHockey.js'),
    minelane:     () => import('./MineLane.js'),
    volleyzap:    () => import('./VolleyZap.js'),
    crowngrab:    () => import('./CrownGrab.js'),
    rocketrelic:  () => import('./RocketRelic.js'),
    pulsepusher:  () => import('./PulsePusher.js'),
    sparksweep:   () => import('./SparkSweep.js'),
    tunnelcharge: () => import('./TunnelCharge.js'),
    shardstorm:   () => import('./ShardStorm.js'),
    flipdisc:     () => import('./FlipDisc.js'),
