...
export const MG_INFO = {
    ...
    minigolf: { icon: '⛳', title: 'MINI GOLF', desc: 'Lay the phone flat between you: you both play the SAME course AT THE SAME TIME, each half of the screen showing it from your own end. DRAG BACK on your half and LET GO to putt — the further you pull, the harder you hit — and go again as soon as your ball stops. The balls knock into each other, so you can bump your rival off line. Three holes, picked at random from seven: the windmill, the loop, the fountain bridge, pinball bumpers, the dogleg, sand traps and the slider. Fewest strokes wins; level on strokes, the quicker time wins.' },
