...
export const MG_INFO = {
    ...
    minigolf: { icon: '⛳', title: 'MINI GOLF', desc: 'Lay the phone flat between you: the screen splits, and you each play your OWN copy of the same hole AT THE SAME TIME, looking down it from your tee. DRAG BACK on your half and LET GO to putt — the further you pull, the harder you hit — and go again as soon as your ball stops. Three holes, picked at random from seven: the windmill, the loop, the fountain bridge, pinball bumpers, the dogleg, sand traps and the slider. Fewest strokes wins; level on strokes, the quicker time wins.' },
