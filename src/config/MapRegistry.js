...
export const MAP_REGISTRY = [
    ...
    },
    {
        ...
        longDesc:  'Explore the Financial District, Back Alley, Shopping Promenade, and Industrial Zone. Earn coins through District HQ bonuses, City Contracts, Ally powers, and Duels. Pick your match length — 6, 12 or 20 rounds. The player with the most coins when the clock runs out wins the city.',
        tags:      ['4 Districts', '~64 Spaces', '6 / 12 / 20 Rounds', 'Allies & Duels'],
        color:     '#60a5fa',
        available: true,
    },
